          ...
          <Box marginBottom={5}>
            <Box>
              ...
              <svg width="398" height="3" viewBox="0 0 398 3" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="1.5" y1="1.5" x2="396.5" y2="1.5" stroke="url(#paint0_linear_263_1158)" stroke-width="3" stroke-linecap="round"/>
                <defs>
                <linearGradient id="paint0_linear_263_1158" x1="0" y1="3" x2="398" y2="3" gradientUnits="userSpaceOnUse">
                <stop stop-color="#24314D"/>
                <stop offset="1" stop-color="#24314D" stop-opacity="0"/>
                </linearGradient>
                </defs>
              </svg>
            </Box>
          ...
          <Box marginBottom={10} sx={{
            ...
            <Box maxWidth={"60%"}>
              <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M32.0833 52.5V29.1667H26.6L32.4333 17.5H15.6917L8.75 31.3833V52.5M26.25 46.6667H14.5833V32.7833L19.3083 23.3333H22.9833L17.15 35H26.25M61.25 52.5V29.1667H55.7667L61.6 17.5H44.8583L37.9167 31.3833V52.5M55.4167 46.6667H43.75V32.7833L48.475 23.3333H52.15L46.3167 35H55.4167V46.6667Z" fill="#0B132A" fill-opacity="0.8"/>
              </svg>
